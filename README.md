...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=700&size=26&duration=3000&pause=1000&color=6366F1&center=true&vCenter=true&width=700&lines=Hi%2C+I'm+Jahanzaib+Iqbal+%F0%9F%91%8B;Principal+Software+Engineer;Full-Stack+%26+AI+Engineer;Co-founder+%40+GSoft+Consulting" alt="Typing SVG" />

<br/>

<a href="https://jahanzaibiqbal.com"><img src="https://img.shields.io/badge/Portfolio-jahanzaibiqbal.com-6366F1?style=for-the-badge&logo=vercel&logoColor=white" /></a>
<a href="https://www.linkedin.com/in/jahanzaib-iqbal-49a42b164/"><img src="https://img.shields.io/badge/LinkedIn-Connect-0077B5?style=for-the-badge&logo=linkedin&logoColor=white" /></a>
<a href="https://calendly.com/jahanzaib-gsoftconsulting/30min"><img src="https://img.shields.io/badge/Book%20a%20Call-Calendly-006BFF?style=for-the-badge&logo=googlecalendar&logoColor=white" /></a>
<a href="mailto:jahanzaib@gsoftconsulting.com"><img src="https://img.shields.io/badge/Email-Say%20Hello-D14836?style=for-the-badge&logo=gmail&logoColor=white" /></a>

<br/><br/>

<img src="https://img.shields.io/badge/8%2B%20Years%20Experience-222?style=flat-square" />
<img src="https://img.shields.io/badge/%241M%2B%20ARR%20Product%20Built-222?style=flat-square" />
...
|---------|-------------|-------|
| [**Obenan**](https://obenan.ai) | Local SEO & digital presence platform · $1M+ ARR · 1,500+ business locations across 43 countries | React, Next.js, NestJS, PostgreSQL, Redis, AWS |
| [**AskCyborg**](https://askcyborg.com) | Agentic AI research platform · 30-page company reports & AI podcasts · cuts research time 75% | Claude, OpenAI, LangChain, RAG, Node.js |
| **HRM AI Assistant** | MCP server connecting Claude to a live HRM · 13 AI tools · HR queries in plain English | Claude, MCP SDK, Node.js, PostgreSQL, Prisma |
| **AI Voice Receptionist** | Human-like AI receptionist for dental clinic · books appointments · handles real interruptions 24/7 | Vapi, ElevenLabs, Twilio, OpenAI, Node.js |
| [**Blend Menu**](https://blend.menu) | Multi-tenant QR ordering SaaS for hotels & restaurants · 13+ live venues · co-funded by Cyprus RIF | Next.js, TypeScript, Node.js, WebSockets, PostgreSQL |
| [**Prism**](https://prism.creamyproducts.com) | AI-powered BI dashboard · NL querying, anomaly detection, automated report digests | Next.js, TypeScript, Node.js, PostgreSQL, AWS |
| [**Cohart**](https://apps.apple.com/us/app/cohart-connect-and-sell-art/id1554034352) | AI social & creator commerce app · 4.8★ App Store · AI captions, smart trimming, personalised feed | React Native, Firebase, AWS, OpenAI |
| [**Udress**](https://apps.apple.com/us/app/udress/id1485435709) | AI fashion marketplace for Middle East · buy/sell/rent · AI visual search & stylist · Arabic RTL | React Native, Redux, NestJS, MySQL, Firebase |
...
| [**Vercel AI SDK**](https://github.com/vercel/ai) · 25k+ ⭐ | [#16510](https://github.com/vercel/ai/pull/16510) 🔄 Open | Fixed `http://` → `https://` link in the Vercel deployment guide |
...
|------|-------|-------------|
| [**react-native-book-app-starter**](https://github.com/jahanzaib-iqbal-dev) | ⭐ 36 | Feature-rich RN book reader — TTS, camera, dark mode, i18n, Redux Saga, CodePush, full auth |
| [**nodejs-boilerplate**](https://github.com/jahanzaib-iqbal-dev) | — | Production-ready Node.js monorepo — Express, MongoDB, JWT, RBAC, Docker, CI/CD, Swagger, Sentry |
| [**project-scaffolding-skills**](https://github.com/jahanzaib-iqbal-dev) | ⭐ 5 | Claude Code skills for scaffolding React, Next.js, React Native & Node.js — 50+ integrations |
...
![Retell](https://img.shields.io/badge/Retell_AI-6366F1?style=flat-square&logoColor=white)
...
![Facebook SDK](https://img.shields.io/badge/Facebook_SDK-1877F2?style=flat-square&logo=facebook&logoColor=white)
...
**[📬 Email](mailto:jahanzaib@gsoftconsulting.com) · [📅 Book a Call](https://calendly.com/jahanzaib-gsoftconsulting/30min) · [🌐 Portfolio](https://jahanzaibiqbal.com)**
